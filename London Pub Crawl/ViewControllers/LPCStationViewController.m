...
- (void)openActionSheet:(id)sender {
    ...
    [[Analytics sharedAnalytics] track:@"Opened map options" properties: @{ @"station" : self.station.name }];
}
...
-(void)actionSheet:(UIActionSheet *)actionSheet clickedButtonAtIndex:(NSInteger)buttonIndex {
    ...
    if ([[actionSheet buttonTitleAtIndex:buttonIndex] isEqualToString:@"Apple Maps"]) {
        ...
        [[Analytics sharedAnalytics] track:@"Directions in Apple Maps" properties: @{ @"station" : self.station.name }];
        ...
        if ([CMMapLauncher isMapAppInstalled:CMMapAppGoogleMaps]) {
            ...
            [[Analytics sharedAnalytics] track:@"Directions in Google Maps App" properties: @{ @"station" : self.station.name }];
        } else {
            ...
            [[Analytics sharedAnalytics] track:@"Directions in Google Maps Website" properties: @{ @"station" : self.station.name }];
        }
        ...
        [[Analytics sharedAnalytics] track:@"Directions in CityMapper" properties: @{ @"station" : self.station.name }];
    }
}
...
- (IBAction)changePub:(id)sender {
    ...
    [[Analytics sharedAnalytics] track:@"Changed to a different pub" properties: @{ @"station" : self.station.name }];
...
- (IBAction)showHelpOverlay:(id)sender {
    [[Analytics sharedAnalytics] track:@"Clicked station help button" properties: @{ @"station" : self.station.name }];
